module.exports = function(app, db) {
    ...
    app.get('/fwconditions', (req, res) => {
        requester.request(Object.assign(url.parse('http://192.168.2.160:8803/fwconditions'), {
            headers: {
                'User-Agent': 'Textservice1'
            },
            service: "Forwarded GET request Texterservice1 -> Texterservice2"
        }), (err, ress) => {
            if(!err)
                res.send(ress.body);
        });
